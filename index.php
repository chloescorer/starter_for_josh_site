  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-4 text-center">
        <img class="img-fluid" src="http://170.187.231.66/~mesh18/ wp-content/themes/starter_for_josh_site/images/archerwoman.jpg ">" alt="painting of an archer">
        <h4 class="article-title">A PORTRAIT</h4>
        <p class="date"> Friday, Nov 10, 2030</p>
      ...
      <div class="col-md-4 text-center">
        <img class="img-fluid" src="http://170.187.231.66/~mesh18/ wp-content/themes/starter_for_josh_site/images/robotmodel.jpg " alt="model of a robot">
        <h4 class="article-title">A PORTRAIT</h4>
        <p class="date"> Friday, Nov 10, 2030</p>
        <p class="article-p">STS has never been shy of seeking new terrains of  investigation. More and  more  STS s cholars are  starting to explore and intervene in the arts.  This object of study  brings  new challenges and  opportunities that we want  to explore in this session.   We would  like to gather first of all simply  new kinds of  knowledge arising from  STS study  of the arts. </p>
        <a class= "readmore"  href="#">CONTINUE READING</a>
      ...
      <div class="col-md-4 text-center">
        <img class="img-fluid" src="http://170.187.231.66/~mesh18/ wp-content/themes/starter_for_josh_site/images/mapmodel.jpg " alt="model of a racetrack map">
        <h4 class="article-title">A PORTRAIT</h4>
        <p class="date"> Friday, Nov 10, 2030</p>
        <p class="article-p">STS has never been shy of seeking new terrains of  investigation. More and  more  STS s cholars are  starting to explore and intervene in the arts.  This object of study  brings  new challenges and  opportunities that we want  to explore in this session.   We would  like to gather first of all simply  new kinds of  knowledge arising from  STS study  of the arts. </p>
        <a class= "readmore"  href="#">CONTINUE READING</a>
